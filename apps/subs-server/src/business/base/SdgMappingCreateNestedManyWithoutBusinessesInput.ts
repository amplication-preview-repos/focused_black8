...
@InputType()
class SdgMappingCreateNestedManyWithoutBusinessesInput {
...
export { SdgMappingCreateNestedManyWithoutBusinessesInput as SdgMappingCreateNestedManyWithoutBusinessesInput };

...
@InputType()
class SurveyResponseCreateNestedManyWithoutBusinessesInput {
...
export { SurveyResponseCreateNestedManyWithoutBusinessesInput as SurveyResponseCreateNestedManyWithoutBusinessesInput };

...
@InputType()
class SurveyResponseUpdateManyWithoutBusinessesInput {
...
export { SurveyResponseUpdateManyWithoutBusinessesInput as SurveyResponseUpdateManyWithoutBusinessesInput };
